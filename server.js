...
/*
app.post("/enviarMail", async function (req, res) {
...
app.post("/enviarMailCarro", function (req, res) {
  let items = []; 
  let items2 = [];
  for (var i = 0; i < req.body.length; i++) {
   items = "Nombre: " + req.body[i].nombre + " </br> " + "Categoria: " + req.body[i].marca + " </br> " + "Precio: " + req.body[i].precio + " </br> " + 
   "Cantidad: " + req.body[i].cantidadEnCarro + " </br> "
    items2.push(items)
  ...
  let mailOptions = {
    ...
    html:` 
    <div> 
    <h5>Por favor verifique que la compra haya sido pagada antes de realizar el envío</h5>
